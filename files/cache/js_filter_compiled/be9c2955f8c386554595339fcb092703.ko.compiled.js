function delete_document(form){ return legacy_filter('delete_document', form, 'marketplace', 'procMarketplaceDeleteDocument', completeDeleteDocument, ['error','message','mid','page'], '', {}) };
(function($){
