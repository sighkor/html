function delete_comment(form){ return legacy_filter('delete_comment', form, 'marketplace', 'procMarketplaceDeleteComment', completeDeleteComment, ['error','message','mid','document_srl','page'], '', {}) };
(function($){
