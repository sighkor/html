...
<table class="x_table x_table-striped x_table-hover">
	...
	<tbody>
		...
		<tr>
			...
			<td><a href="#" onclick="doDocumentSelect('<?php echo $__Context->val->document_srl ?>', '<?php echo $__Context->val->getDocumentType() ?>'); return false;" class="buttonSet buttonActive"><span><?php echo $__Context->lang->cmd_select ?></span></a></td>
		</tr>
		<?php } ?>
	</tbody>
</table>
