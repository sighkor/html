...
if($__Context->filter_type==disable){ ?>(<?php echo $__Context->total_count ?>)<?php } ?></a>
		...
		<thead>
			<tr>
				...
				<th scope="col" class="nowr"><a href="<?php echo getUrl('', 'module', 'admin', 'act', 'dispMemberAdminList', 'sort_index', 'regdate', 'sort_order', ($__Context->sort_order == 'asc') ? 'desc' : 'asc', 'selected_group_srl', $__Context->selected_group_srl) ?>"><?php echo $__Context->lang->signup_date;
if($__Context->sort_index == 'regdate'){ ?> <?php if($__Context->sort_order=='asc'){ ?><em>▲</em><?php };
if($__Context->sort_order != 'asc'){ ?><em>▼</em><?php };
} ?></a></th>
				<th scope="col" class="nowr"><a href="<?php echo getUrl('', 'module', 'admin', 'act', 'dispMemberAdminList', 'sort_index', 'last_login', 'sort_order',  ($__Context->sort_order == 'asc') ? 'desc' : 'asc', 'selected_group_srl', $__Context->selected_group_srl) ?>"><?php echo $__Context->lang->last_login;
