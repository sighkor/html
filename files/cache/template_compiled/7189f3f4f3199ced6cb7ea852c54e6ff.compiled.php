<?php if(!defined("__XE__"))exit;?><ul id="cl" class="rp tgo open">
	...
	<li>
		...
		<span class="auth">
			...
			<a href="<?php echo getUrl('act','dispMarketplaceDeleteComment','comment_srl',$__Context->comment->comment_srl) ?>" class="bn white small"><?php echo $__Context->lang->cmd_delete ?></a>
			<?php } ?>
			<a href="<?php echo getUrl('act','dispMarketplaceReplyComment','comment_srl',$__Context->comment->comment_srl) ?>" class="bn white small"><?php echo $__Context->lang->cmd_reply ?></a>
