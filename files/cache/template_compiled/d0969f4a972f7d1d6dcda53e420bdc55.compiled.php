			...
			<table class="__join_form sortable x_table x_table-striped x_table-hover">
				...
				<tbody class="uDrag">
					...
					<tr class="sticky">
						...
						<th scope="row">
							<span class="_title" style="display:inline-block;white-space:pre-line;overflow:inherit;width:120px;text-overflow:ellipsis;padding-left:20px"><?php echo $__Context->item->title ?> <a class="x_icon-question-sign" href="./admin/help/index.html#UMAN_login_key" target="_blank"><?php echo $__Context->lang->help ?></a></span>
						</th>
