...
${'history_srl23_argument'} = new ConditionArgument('history_srl', $args->history_srl, 'equal');
${'history_srl23_argument'}->checkFilter('number');
${'history_srl23_argument'}->createConditionValue();
if(!${'history_srl23_argument'}->isValid()) return ${'history_srl23_argument'}->getErrorMessage();
} else
${'history_srl23_argument'} = NULL;if(${'history_srl23_argument'} !== null) ${'history_srl23_argument'}->setColumnType('number');
...
new ConditionWithArgument('`history_srl`',$history_srl23_argument,"equal")
